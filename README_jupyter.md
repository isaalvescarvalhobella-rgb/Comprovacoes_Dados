...
```bash
git clone https://github.com/isaalvescarvalhobella-rgb/Comprovacoes_Dados/blob/main/README_jupyter%20(1).md
```

2. Acesse o diretório:

```bash
cd Comprovacoes_Dados
```

3. Abra o notebook no Jupyter ou Google Colab:

- [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/isaalvescarvalhobella-rgb/Comprovacoes_Dados/blob/main/Copia_de_Exercicio_python.ipynb)
- Ou localmente com:  
  ```bash
  jupyter notebook
  ```
